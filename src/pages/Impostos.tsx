...
import { Filter, Calculator, DollarSign, Trash2, Edit, HelpCircle } from "lucide-react";
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Permite modificar as informações do imposto, incluindo tipo, valor, período e lançamento associado.
              </p>
              <p className="text-sm font-medium">
                Risco: <span className="text-yellow-600">Médio</span>
              </p>
              <p className="text-sm text-muted-foreground">
                Alterações podem impactar relatórios fiscais e cálculos de impostos.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Remove permanentemente o registro de imposto do sistema.
              </p>
              <p className="text-sm font-medium">
                Risco: <span className="text-red-600">Alto</span>
              </p>
              <p className="text-sm text-muted-foreground">
                Esta ação é irreversível e pode afetar sua conformidade fiscal.
              </p>
            </div>
            ...
            <div className="border-t pt-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                ...
                <li>Mantenha backups regulares dos seus registros fiscais</li>
                <li>Use os filtros para localizar impostos específicos</li>
                <li>Verifique se os valores estão vinculados corretamente aos lançamentos</li>
                <li>Consulte os relatórios após alterações para garantir consistência</li>
                <li>Em caso de dúvida, consulte um contador antes de excluir registros</li>
              </ul>
            </div>
          </div>
