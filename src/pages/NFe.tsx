...
import { Plus, FileText, Download, Eye, Edit, Trash2, Search, Upload, HelpCircle } from "lucide-react";
...
export default function NFe() {
  ...
  const handleCreateNFe = async () => {
    ...
    if (!newNfe.numero.trim() || !newNfe.serie.trim()) {
      toast({
        title: "Erro",
        description: "Os campos Número e Série são obrigatórios e devem conter apenas números.",
        variant: "destructive",
      });
      return;
    }
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      value={newNfe.numero}
                      onChange={(e) =>
                        setNewNfe({ ...newNfe, numero: e.target.value.replace(/\D/g, "") })
                      }
                      placeholder="000123"
                      required
                    />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      value={newNfe.serie}
                      onChange={(e) =>
                        setNewNfe({ ...newNfe, serie: e.target.value.replace(/\D/g, "") })
                      }
                      placeholder="001"
                      required
                    />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setEditNfe({ ...editNfe, numero: e.target.value.replace(/\D/g, "") })
                  }
                  placeholder="000123"
                  required
                />
              ...
              <div>
                ...
                <Input
                  ...
                  value={editNfe.serie}
                  onChange={(e) =>
                    setEditNfe({ ...editNfe, serie: e.target.value.replace(/\D/g, "") })
                  }
                  placeholder="001"
                  required
                />
      ...
      <Dialog open={helpDialogOpen} onOpenChange={setHelpDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Entenda o que cada ação faz e os riscos envolvidos
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-semibold">Visualizar XML</h4>
              </div>
              <p className="text-sm text-muted-foreground">
                Permite visualizar o conteúdo completo do XML da NFe em uma janela de diálogo.
              </p>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-semibold">Baixar XML</h4>
              </div>
              <p className="text-sm text-muted-foreground">
                Faz o download do arquivo XML da NFe para o seu dispositivo.
              </p>
              <div className="flex items-center gap-2 text-xs">
                <Badge variant="outline" className="bg-success/10 text-success border-success/20">
                  Risco: Nenhum
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Permite modificar as informações da NFe como número, série, valor, data de emissão, lançamento vinculado e conteúdo XML.
              </p>
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="text-muted-foreground">
                  Alterações podem impactar relatórios fiscais e vínculos com lançamentos.
                </span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-semibold">Excluir</h4>
              </div>
              <p className="text-sm text-muted-foreground">
                Remove permanentemente a NFe do sistema.
              </p>
              <div className="flex items-center gap-2 text-xs">
                ...
                <span className="text-muted-foreground">
                  Esta ação é irreversível! Certifique-se antes de excluir.
                </span>
              </div>
            </div>

            <div className="border-t pt-4 space-y-2">
              <h4 className="font-semibold text-sm">Dicas Importantes:</h4>
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                <li>Sempre revise os dados antes de editar ou excluir uma NFe</li>
                <li>Faça backups regulares das suas NFes importantes</li>
                <li>Use os filtros de busca para encontrar NFes específicas</li>
                <li>Verifique se há lançamentos vinculados antes de excluir</li>
                <li>Guarde os arquivos XML em local seguro para fins fiscais</li>
                <li>Consulte os relatórios para acompanhar o impacto das alterações</li>
              </ul>
            </div>
          </div>
        </DialogContent>
